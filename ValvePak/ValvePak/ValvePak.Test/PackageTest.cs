	...
	public class PackageTest
	{
		...
		public void TestFileReadWithPreloadedBytes()
		{
			...
			Assert.Multiple(() =>
			{
				...
				Assert.That(file.SmallData, Is.EqualTo(Encoding.UTF8.GetBytes("Lorem ipsum dolor sit amet, consectetur adipiscing elit.")));
				Assert.That(
					allBytes,
					Is.EqualTo(Encoding.UTF8.GetBytes("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam aliquam dapibus lorem, id suscipit urna pharetra non. " +
