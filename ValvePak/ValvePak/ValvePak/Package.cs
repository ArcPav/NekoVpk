...
namespace SteamDatabase.ValvePak
{
	...
	public partial class Package : IDisposable
	{
		...
		/// <summary>
		/// Gets or sets the text encoding used for file names in this package.
		/// Defaults to UTF-8. 
		/// If GBK (CodePage 936) is detected during reading, this will be automatically updated.
		/// </summary>
...
#pragma warning disable CA1031 // Do not catch general exception types
			...
			{
				// 忽略异常。如果注册失败，Package.Read.cs 中尝试获取 GBK 编码时会捕获 NotSupportedException
			}
